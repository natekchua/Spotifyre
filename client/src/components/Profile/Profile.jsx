...
function Profile() {
  ...
  const [{ user, userSettings }, dispatch] = useProviderValue();

  const [curatorMode, setCuratorMode] = useState(userSettings.curatorMode);
  const [maxSuggestions, setMaxSuggestions] = useState(
    userSettings.maxSuggestions
  );
  const [suggestionsPerUser, setSuggestionsPerUser] = useState(
    userSettings.suggestionsPerUser
  );
  ...
  return (
    <div className="profile-container flex-basic">
      ...
      <div className="curator-info p10">
        <Badge className="help-icon" onClick={openHelp} color="secondary">
          <InfoOutlinedIcon />
        </Badge>
        <h3 className="p5">Curator Mode</h3>
        <Switch checked={curatorMode} onChange={toggleCuratorMode} />
      </div>
      <Modal
      ...
      >
        <Fade in={helpOpen}>
          <div className={classes.paper}>
            <div className="help-box flex-basic">
      ...
      {curatorMode ? (
        <div id="curator-settings-container">
          <div className="profile-sliders">
            ...
            <div className="slider-info flex-basic p10">
              ...
              <Slider
                value={
                  typeof suggestionsPerUser === "number"
                    ? suggestionsPerUser
                    : 0
                }
        ...
        <h2>
          Enable Curator Mode to adjust your playlist suggestion settings.
        </h2>
      )}
      <div className="p20">
